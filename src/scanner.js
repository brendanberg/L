...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c135 = function(expList) {
      			return new Skel.Type({
      				exprs: expList || List([]),
      				tags: Map({envelopeShape: '<<>>'})
      			});
      		},
      peg$c136 = peg$otherExpectation("symbol"),
      peg$c137 = ".",
      ...
      peg$c141 = peg$otherExpectation("type variable"),
      peg$c142 = "$",
      ...
      peg$c146 = function(l, mod) {
      			return new AST.Identifier({label: l, modifier: mod});
      		},
      peg$c147 = function(first, rest) { return first + rest.join(''); },
      peg$c148 = /^[a-zA-Z_]/,
      peg$c149 = peg$classExpectation([["a", "z"], ["A", "Z"], "_"], false, false),
      peg$c150 = /^[\xA8\xAA\xAD\xAF\xB2-\xB5\xB7-\xBA]/,
      peg$c151 = peg$classExpectation(["\xA8", "\xAA", "\xAD", "\xAF", ["\xB2", "\xB5"], ["\xB7", "\xBA"]], false, false),
      peg$c152 = /^[\xBC-\xBE\xC0-\xD6\xD8-\xF6\xF8-\xFF]/,
      peg$c153 = peg$classExpectation([["\xBC", "\xBE"], ["\xC0", "\xD6"], ["\xD8", "\xF6"], ["\xF8", "\xFF"]], false, false),
      peg$c154 = /^[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF\u1E00-\u1FFF]/,
      peg$c155 = peg$classExpectation([["\u0100", "\u02FF"], ["\u0370", "\u167F"], ["\u1681", "\u180D"], ["\u180F", "\u1DBF"], ["\u1E00", "\u1FFF"]], false, false),
      peg$c156 = /^[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/,
      peg$c157 = peg$classExpectation([["\u200B", "\u200D"], ["\u202A", "\u202E"], ["\u203F", "\u2040"], "\u2054", ["\u2060", "\u206F"]], false, false),
      peg$c158 = /^[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793\u2C00-\u2DFF\u2E80-\u2FFF]/,
      peg$c159 = peg$classExpectation([["\u2070", "\u20CF"], ["\u2100", "\u218F"], ["\u2460", "\u24FF"], ["\u2776", "\u2793"], ["\u2C00", "\u2DFF"], ["\u2E80", "\u2FFF"]], false, false),
      peg$c160 = /^[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/,
      peg$c161 = peg$classExpectation([["\u3004", "\u3007"], ["\u3021", "\u302F"], ["\u3031", "\u303F"], ["\u3040", "\uD7FF"]], false, false),
      peg$c162 = /^[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44\uFE47-\uFFFD]/,
      peg$c163 = peg$classExpectation([["\uF900", "\uFD3D"], ["\uFD40", "\uFDCF"], ["\uFDF0", "\uFE1F"], ["\uFE30", "\uFE44"], ["\uFE47", "\uFFFD"]], false, false),
      peg$c164 = /^[\uD800-\uDBFF]/,
      peg$c165 = peg$classExpectation([["\uD800", "\uDBFF"]], false, false),
      peg$c166 = /^[\uDC00-\uDFFF]/,
      peg$c167 = peg$classExpectation([["\uDC00", "\uDFFF"]], false, false),
      peg$c168 = function(h, l) { return h + l; },
      peg$c169 = /^[0-9\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F\-]/,
      peg$c170 = peg$classExpectation([["0", "9"], ["\u0300", "\u036F"], ["\u1DC0", "\u1DFF"], ["\u20D0", "\u20FF"], ["\uFE20", "\uFE2F"], "-"], false, false),
      peg$c171 = peg$otherExpectation("number"),
      peg$c172 = "0",
      peg$c173 = peg$literalExpectation("0", false),
      peg$c174 = function() { return new AST.Integer({value: 0, tags: Map({'source_base': 10})}); },
      peg$c175 = /^[1-9]/,
      ...
      peg$c185 = function(sig, mant) {
      			return new AST.Scientific({significand: sig, mantissa: mant});
      		},
      peg$c186 = "0x",
      peg$c187 = peg$literalExpectation("0x", false),
      peg$c188 = /^[1-9a-fA-F]/,
      peg$c189 = peg$classExpectation([["1", "9"], ["a", "f"], ["A", "F"]], false, false),
      peg$c190 = /^[0-9a-fA-F]/,
      peg$c191 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"]], false, false),
      peg$c192 = function(pad, first, rest) {
      			var val = parseInt(first + rest.join(''), 16);
      			return new AST.Integer({value: val, tags: Map({'source_base': 16})});
      		},
      peg$c193 = "0x0",
      peg$c194 = peg$literalExpectation("0x0", false),
      peg$c195 = function() {
      			return new AST.Integer({value: 0, tags: Map({'source_base': 16})});
      		},
      peg$c196 = /^[ijJ]/,
      peg$c197 = peg$classExpectation(["i", "j", "J"], false, false),
      peg$c198 = function(num) {
      			let zero = AST.Integer({value: 0, tags: Map({'source_base': 10})});
      			return new AST.Complex({real: zero, imaginary: num});
      		},
      peg$c199 = peg$otherExpectation("text"),
      peg$c200 = "\n",
      peg$c201 = peg$literalExpectation("\n", false),
      peg$c202 = peg$anyExpectation(),
      peg$c203 = function(char) { return char; },
      peg$c204 = function(seq) { return seq; },
      peg$c205 = "a",
      peg$c206 = peg$literalExpectation("a", false),
      peg$c207 = function() { return "\x07"; },
      peg$c208 = "b",
      peg$c209 = peg$literalExpectation("b", false),
      peg$c210 = function() { return "\b"; },
      peg$c211 = "f",
      peg$c212 = peg$literalExpectation("f", false),
      peg$c213 = function() { return "\f"; },
      peg$c214 = "n",
      peg$c215 = peg$literalExpectation("n", false),
      peg$c216 = function() { return "\n"; },
      peg$c217 = "r",
      peg$c218 = peg$literalExpectation("r", false),
      peg$c219 = function() { return "\r"; },
      peg$c220 = "t",
      peg$c221 = peg$literalExpectation("t", false),
      peg$c222 = function() { return "\t"; },
      peg$c223 = "v",
      peg$c224 = peg$literalExpectation("v", false),
      peg$c225 = function() { return "\x0B"; },
      peg$c226 = "u{",
      peg$c227 = peg$literalExpectation("u{", false),
      peg$c228 = function(ch) { return ch; },
      peg$c229 = peg$otherExpectation("codepoint"),
      peg$c230 = function(ch) {
      		return String.fromCodePoint(parseInt(ch.join(''), 16));
      	},
      peg$c231 = peg$otherExpectation("hex"),
      peg$c232 = peg$otherExpectation("whitespace"),
      peg$c233 = peg$otherExpectation("separator"),
      peg$c234 = /^[,\n]/,
      ...
      peg$c240 = peg$otherExpectation("comment"),
      peg$c241 = "#-",
